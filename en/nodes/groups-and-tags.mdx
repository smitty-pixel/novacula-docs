...
Constrain to one of the [computed lifecycle phases](/en/nodes/node-lifecycle#state-machine):
...
The same filters are available on the GraphQL `nodes` query — see [GraphQL API](/en/reference/graphql-api).
