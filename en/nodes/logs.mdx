...
- [Node monitoring](/en/nodes/monitoring) — for sync progress, peers, and per-process metrics that *are* persisted.
- [Events feed](/en/notifications/events-feed) — for structured events (lifecycle transitions, errors) that *are* persisted.
