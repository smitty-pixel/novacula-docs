...
Executor upgrades are normally **fully automatic**. You request the upgrade in the UI ([Upgrade an executor](/en/executors/upgrade-executor)), the executor self-applies on its next sync, and the new version reports back. The infrastructure side has nothing to do.
