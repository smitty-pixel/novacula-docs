...
| Aspect | [Agent](/docs/executors/agent-bare-metal) | [Operator](/docs/executors/operator-kubernetes) |
| --- | --- | --- |
...
See [Connect an executor](/docs/executors/connect-an-executor) for the bring-up flow that's common to both.
