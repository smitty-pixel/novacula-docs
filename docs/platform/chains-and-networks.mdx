...
See [Supported chains](/docs/chains/overview) for the matrix of what's available right now.
...
Roles matter because each role gets its own client choice, version, and override surface. They also drive log scoping — see [Node logs](/docs/nodes/logs) — so you can stream EL logs and CL logs independently.
...
See [Executor capabilities](/docs/executors/executor-capabilities).

## Per-chain pages

For port numbers, default storage sizes, override matrices, and notes on each supported chain, see [Supported chains overview](/docs/chains/overview) and the per-chain pages: [Bitcoin](/docs/chains/bitcoin), [BSC](/docs/chains/bsc), [Ethereum](/docs/chains/ethereum), [Sui](/docs/chains/sui), [Tron](/docs/chains/tron).
