...
- **Authentication.** All sessions go through better-auth. UI sessions are cookie-based; executors authenticate with org-scoped API keys (see [API keys](/docs/account/api-keys)).
...
See [Members and invitations](/docs/account/members-and-invitations) for the full flow.
