...
The adapter scrapes `bitcoind`'s JSON-RPC for height, peers, and verification progress, and reports them on every reporter tick. See [Node monitoring](/docs/nodes/monitoring) for what's surfaced.
