...
- [Provision an executor on bare-metal](/recipes/provision-on-bare-metal) — full install walkthrough.
- [Apply executor upgrades](/recipes/apply-upgrades) — recovery for stuck self-updates.
- [Configuration reference](/reference/configuration) — the agent TOML schema.
